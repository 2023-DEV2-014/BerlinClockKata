...
extension BerlinClock.MinuteState {
  static var expectedStateByMinuteValue: [Self] = [
    // 0
    .init(
      topRow: [.off, .off, .off, .off, .off, .off, .off, .off, .off, .off, .off],
      bottomRow: [.off, .off, .off, .off]
    ),
    // 1
    .init(
    ...
    // 5
    .init(
      topRow: [.illuminated, .off, .off, .off, .off, .off, .off, .off, .off, .off, .off],
      bottomRow: [.off, .off, .off, .off]
    ),
    // 6
    .init(
    ...
    // 20
    .init(
      topRow: [.illuminated, .illuminated, .marked, .illuminated, .off, .off, .off, .off, .off, .off, .off],
      bottomRow: [.off, .off, .off, .off]
    ),
    // 21
    .init(
    ...
    // 25
    .init(
      topRow: [.illuminated, .illuminated, .marked, .illuminated, .illuminated, .off, .off, .off, .off, .off, .off],
      bottomRow: [.off, .off, .off, .off]
    ),
    // 26
    .init(
    ...
    // 30
    .init(
      topRow: [.illuminated, .illuminated, .marked, .illuminated, .illuminated, .marked, .off, .off, .off, .off, .off],
      bottomRow: [.off, .off, .off, .off]
    ),
  ]
}
